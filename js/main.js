    ...
    var aiwaveJs = {
        ...
        popupMobileMenu: function (e) {
            ...
            $('.close-menu').on('click', function (e) {
                ...
                $('.popup-mobile-menu .mainmenu .has-dropdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').siblings('.submenu, .Aparajayah-megamenu').removeClass('active').slideUp('400');
                $('.popup-mobile-menu .mainmenu .has-dropdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').removeClass('open')
            });

            $('.popup-mobile-menu .mainmenu .has-dropdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').on('click', function (e) {
                e.preventDefault();
                $(this).siblings('.submenu, .Aparajayah-megamenu').toggleClass('active').slideToggle('400');
                $(this).toggleClass('open')
            })

            $('.popup-mobile-menu, .popup-mobile-menu .mainmenu.onepagenav li a').on('click', function (e) {
                e.target === this && $('.popup-mobile-menu').removeClass('active') && $('.popup-mobile-menu .mainmenu .has-dropdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').siblings('.submenu, .Aparajayah-megamenu').removeClass('active').slideUp('400') && $('.popup-mobile-menu .mainmenu .has-dropdown > a, .popup-mobile-menu .mainmenu .with-megamenu > a').removeClass('open');
            });
        },
        ...
        slickSliderActivation: function () {
            ...
            $('.Aparajayah-service-slider-actvation').not('.slick-initialized').slick({
                infinite: true,
                slidesToShow: 3,
                slidesToScroll: 2,
                dots: true,
        ...
        backToTopInit: function () {
            var scrollTop = $('.Aparajayah-back-top');
        ...
        contactForm: function () {
            $('.Aparajayah-dynamic-form').on('submit', function (e) {
				e.preventDefault();
				var _self = $(this);
				...
				$.ajax({
					...
					success: function (data) {
						...
						if (data.code == false) {
							...
							_self.find('.Aparajayah-btn').after('<div class="error-msg"><p>*' + data.err + '</p></div>');
						} else {
							$('.error-msg').hide();
							$('.form-group').removeClass('focused');
							_self.find('.Aparajayah-btn').after('<div class="success-msg"><p>' + data.success + '</p></div>');
